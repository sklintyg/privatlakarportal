angular.module('privatlakareApp')
  .controller('Step3Ctrl', function ($scope, RegisterViewStateService, UserModel, RegisterModel) {
        ...
        $scope.uppgifter = [
            ...
            { name: 'Befattning', value: (!RegisterModel.befattning) ? '' : RegisterModel.befattning.label },
            ...
            { name: 'Verksamhetstyp', value: (!RegisterModel.verksamhetstyp) ? '' : RegisterModel.verksamhetstyp.label },
