...
angular.module('privatlakareApp')
    .controller('MainTermsCtrl', function ($scope, $http, $window) {
        ...
        $scope.terms = "Dessa användarvillkor (\"Användarvillkoren\") ska gälla mellan Inera AB (\"Inera\") och användare av tjänsten Webcert (\"Kunden\").\n"+
            "\n"+
            "Version 1.0\n"+
            "Uppdaterad 2015-05-06\n"+
            "\n"+
            "1.     Beskrivning av Webcert\n"+
            "Webcert är en tjänst som möjliggör för Kunden att skapa nya läkarintyg, komplettera befintliga läkarintyg, kopiera tidigare utfärdade läkarintyg samt skicka läkarintyg till externa aktörer, t.ex. Försäkringskassan. Oavsett om läkarintyg lagras lokalt hos Kunden eller inte, sker lagring alltid på lagringsyta som förvaltas av Inera (”Intygstjänsten”). Vid kopiering och komplettering av läkarintyg i Webcert, hämtas befintliga läkarintyg från Intygstjänsten. Webcert möjliggör även för Kunden att skicka till och ta emot meddelanden från externa aktörer, t.ex. Försäkringskassan.\n"+
            ...
            "Webcert tillhandahålls som en webbtjänst och kräver inloggning med SITHS eller e-legitimation. SITHS är en identifieringstjänst som tillhandahålls av Inera och innebär en tjänstelegitimation för både fysisk och elektronisk identifiering.\n"+
